...
DNS_TOKEN='dynu_token'

# disable the dashboard after everything is working, there is no encryption in the dashboard.
TRAEFIK_DASHBOARD=true

# disable the debug after everything is working
TRAEFIK_DEBUG=true
...
sudo docker ps
sudo docker logs --follow traefik
